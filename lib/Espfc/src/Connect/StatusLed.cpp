...
static int LED_WARNING_PATTERN[] = {150, 150, 0};
...
StatusLed::StatusLed() : _pin(-1), _invert(0), _status(LED_OFF), _next(0), _step(0), _locked(false), _pattern(nullptr) {}
...
void StatusLed::setStatus(LedStatus newStatus, bool force)
{
  ...
  _locked = (newStatus == LED_INIT || newStatus == LED_GYRO);
