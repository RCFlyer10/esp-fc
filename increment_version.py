...
with open(GEN_SRC, "w") as f:
    ...
    f.write(f'extern "C" const char * const targetVersion __attribute__((weak)) = "v{version}";\n')
    f.write(f'extern "C" const char * const shortGitRevision __attribute__((weak)) = "{current_hash}";\n')
